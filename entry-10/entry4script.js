...
// Update confetti dimensions and position
initConfetti = () => {
  for (let i = 0; i < confettiCount; i++) {
    confetti.push({
      color: colors[Math.floor(randomRange(0, colors.length))],
      dimensions: {
        x: randomRange(5, 10), // Adjusted smaller width
        y: randomRange(5, 15) }, // Adjusted smaller height

      position: {
        x: randomRange(0, canvas.width),
        y: randomRange(0, canvas.height / 2) }, // Positioned on top half of the canvas
